...
(5) \emph{ReceiveEvent}\textunderscore
\\*\emph{asynchCall}; and (6) \emph{SendEvent}\textunderscore\emph{asynchCall}.
\begin{figure}[!b]
\centering
%\figshrink
...
Both \emph{MessageOccurrenceSpecifications} and \emph{CombinedFragments} 
...
\centering
%\figshrink
\includegraphics[width=1.0\linewidth]{./Figure7_final.png}
